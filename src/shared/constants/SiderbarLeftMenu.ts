const SiderbarLeftMenu = [
  ...
  { icon: 'Sdelki', text: 'Сделки', path: '/deals' },
  { icon: 'RabGrafik', text: 'Рабочий график', path: '/work_schedule' },
  { icon: 'Servis', text: 'Сервисы' },
];

export const SiderbarLeftServises = [
  // { icon: 'Dot', text: 'Расчёт доставки СДЕК', path: 'CDEK' },
  // { icon: 'Dot', text: 'Доступы к сервисам', path: 'accesses' },
